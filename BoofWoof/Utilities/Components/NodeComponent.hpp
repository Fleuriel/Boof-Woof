...
//class NodeComponent {
//public:
//    NodeComponent(); // Move constructor definition to .cpp file
//
//    // Setters
//    void SetPosition(const glm::vec3& pos) { position = pos; }
//    void SetWalkable(bool walkable) { isWalkable = walkable; }
//    void SetNodeID(uint32_t id) { nodeID = id; } // Allow setting a specific ID (if needed)
//
//    // Getters
//    glm::vec3 GetPosition() const { return position; }
//    bool IsWalkable() const { return isWalkable; }
...
//class NodeComponent {
//public:
//    NodeComponent() : position(0.0f), isWalkable(true), nodeID(++nodeCounter) {} // Assign unique node ID
//
//    // Setters
//    void SetPosition(const glm::vec3& pos) { position = pos; }
//    void SetWalkable(bool walkable) { isWalkable = walkable; }
//    void SetNodeID(uint32_t id) { nodeID = id; } // Allow ID to be set explicitly
//
//    // Getters
//    glm::vec3 GetPosition() const { return position; }
//    bool IsWalkable() const { return isWalkable; }
...
//    uint32_t nodeID; // Unique node ID
//
//    static uint32_t nodeCounter; // Global counter for unique node IDs
//};
//
//#endif
//#pragma warning(pop)
