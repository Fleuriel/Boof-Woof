...
void Model::DrawCollisionBox3D(glm::vec3 position, glm::vec3 halfExtents,glm::vec3 rotation, glm::vec3 color) const
{
	// Bind the VAO for the outline model

	Model AABBOutline = OBB(position, halfExtents, rotation, color);
